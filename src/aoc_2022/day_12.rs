...
mod solution {
    ...
    impl Square {
        /// Returns the numerical height of the square, with `a` being zero and
        /// `z` being 25.
        ///
        /// Note that the start space has height 0 and the end space has height
        /// 25.
    ...
    pub struct HeightMap {
        ...
        ///
        /// The nodes are the spaces and the edges represent directed paths
    ...
    impl HeightMap {
        ...
        /// the shortest path length from the `start` square to the designated
        /// end square.
        ///
        /// The shortest path length is returned, or [`None``] if there is no
        ...
        /// Determines the shortest path length from the designated start space
        /// to the designated end space.
        ///
        ...
        /// Determines the shortest among all the shortest path lengths from
        /// every lowest square, that is squares with a height of 0 (`a`
        /// in the original map ).
        ///
        /// Note that this of course includes the designated start square.
        /// Returns an error if none of the lowest squares have a complete path
        /// to the end square at all.
